...
local function create_mixups(layout, keyword)
  local mixups = {}
...
local function create_all_mixups(layout, keywords)
  local all_mixups = {}
  for _, keyword in ipairs(keywords) do
    local keyword_mixups = {}
    local mixups = create_mixups(layout, keyword)
...
M.get = function(layout, language)
  return create_all_mixups(layout, keywords_mod.languages[language])
end
